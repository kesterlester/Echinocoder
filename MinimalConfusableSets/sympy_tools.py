...
def max_height_for_rre_without_zero_rows(M, k):
    """
    A viable RRE-form match-matrix is one that can be solved without causing collapse 
    (i.e. with all alphas non-zero).
