...
with the first three columns cyclically shifted.  We may therefore write $M'\sim  M$.  Note that two columns of the matrix $M$ happen to be identical, both being $(2,9)$.  Multisets (unlike sets) can contain such repeated elements, although it is also fine if they do no have repeats.
\end{example}
