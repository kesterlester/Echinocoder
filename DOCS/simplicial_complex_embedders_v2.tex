...
6 & 1 & $\eji{0}{2}$ & 0 & 0
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
    ...
    ${}+\eji{0}{2}$ \\[3pt]
7 & 1 & $\eji{0}{2}+\eji{2}{2}+\eji{3}{2}$ & 1 & 8
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
    ${}+\eji{1}{1}+3\eji{2}{1}+2\eji{3}{1}$\newline
    ${}+2\eji{0}{2}+\eji{2}{2}+\eji{3}{2}$ \\[3pt]
8 & 0 & $\eji{0}{2}+\eji{2}{2}$ & 0 & 0
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
    ${}+\eji{1}{1}+3\eji{2}{1}+2\eji{3}{1}$\newline
