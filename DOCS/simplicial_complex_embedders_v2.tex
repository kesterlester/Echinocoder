...
\[
  5,\;4,\;3,\;2,\;2,\;2,\;1,\;1,\;0
\]
The table below assigns the rank index $s$, shows which prefix element
$V_{(s)}$ each sorted gap is associated with (written as an Eji sum), and
accumulates these into the cumulative LinComb $L_s = V_{(0)}+\cdots+V_{(s)}$.
Terms within each expression are grouped by coordinate row $i$.

\begin{center}
\small
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.35}
\begin{tabular}{cc p{3.8cm} p{6.6cm}}
\toprule
$s$ & $\delta_{(s)}$
    & Individual prefix element $V_{(s)}$
    & Cumulative $L_s$ \\
\midrule
0 & 5
  & $\eji{0}{0}+\eji{2}{0}+\eji{3}{0}$
  & $\eji{0}{0}+\eji{2}{0}+\eji{3}{0}$ \\[3pt]
1 & 4
  & $\eji{2}{0}$
  & $\eji{0}{0}+2\eji{2}{0}+\eji{3}{0}$ \\[3pt]
2 & 3
  & $\eji{1}{1}+\eji{2}{1}+\eji{3}{1}$
  & $\eji{0}{0}+2\eji{2}{0}+\eji{3}{0}$\newline
    ${}+\eji{1}{1}+\eji{2}{1}+\eji{3}{1}$ \\[3pt]
3 & 2
  & $\eji{0}{0}+\eji{2}{0}$
...
4 & 2
  & $\eji{2}{1}$
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
    ${}+\eji{1}{1}+2\eji{2}{1}+\eji{3}{1}$ \\[3pt]
5 & 2
  & $\eji{2}{1}+\eji{3}{1}$
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
    ${}+\eji{1}{1}+3\eji{2}{1}+2\eji{3}{1}$ \\[3pt]
6 & 1
  & $\eji{0}{2}$
  & $2\eji{0}{0}+3\eji{2}{0}+\eji{3}{0}$\newline
...
\]
\begin{tcolorbox}[notebox]
\textbf{Coincidence in this example.}  Every non-zero $\delta$ difference
...
The cumulative Eji\_LinComb for each non-zero term.  Count matrix: rows =
coordinates $i{=}0,1,2$; columns = vectors $j{=}0,1,2,3$.
The last column shows $L_s/(s{+}1)$ — the normalised basis element, i.e.\ the
average of the first $s{+}1$ prefix MSVs.  Terms of $\eji{j}{i}$ with
coefficient~0 are omitted; terms are grouped by coordinate row~$i$.
\begin{center}
\small
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.2}
...
\toprule
$s$ & $\alpha_s$ & $L_s$ (count matrix, idx $s{+}1$)
    & Normalised basis element $L_s/(s{+}1)$ \\
\midrule
0 & 1
